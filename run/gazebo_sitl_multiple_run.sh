...
source ./setup_gazebo.bash ${src_path} ${src_path}/build/${target}
...
#gzserver ${src_path}/Tools/sitl_gazebo/worlds/${world}.world --verbose $ros_args &
gzserver ${SCRIPT_DIR}/../world/empty_world.world --verbose $ros_args &
sleep 5

gz model --spawn-file=${SCRIPT_DIR}/../models/droneport/model.sdf --model-name=droneport_01 -x 0.0 -y 0.0 -z 0.2
sleep 2	
gz model --spawn-file=${SCRIPT_DIR}/../models/droneport2/model.sdf --model-name=droneport_02 -x 0.0 -y 3.0 -z 0.2
sleep 2
