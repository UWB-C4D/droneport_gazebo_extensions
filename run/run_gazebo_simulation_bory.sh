...
sleep 5
gz model --spawn-file=${SCRIPT_DIR}/../models/droneport/model.sdf --model-name=droneport1 -x 0.0 -y 0.0 -z 0.2 -Y 1.57
#sleep 2	
...
#sleep 2
gz model --spawn-file=${SCRIPT_DIR}/../models/drone1/model.sdf --model-name=drone1 -x 0.0 -y 0.0 -z 0.5 -Y 1.57
#sleep 2
...
#sleep 2
gz model --spawn-file=${SCRIPT_DIR}/../models/drone2/model.sdf --model-name=drone2 -x 7.2 -y 0.0 -z 0.5 -Y 1.57
sleep 2
